package com.lightingoverhaul.coremod.network;
...
public class PacketHandler {
    ...
    public static final SimpleNetworkWrapper INSTANCE = NetworkRegistry.INSTANCE.newSimpleChannel(Tags.MODIDCAPITALIZED + "Core");
